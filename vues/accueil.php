 ...
 */
echo outilsHTML::enteteHTML("Spot Hi-Fi","UTF-8","vues/bootstrap/css/bootstrap.min.css");
echo outilsHTML::headerHtml();
?>

<h1 class="text-center">Accueil du site</h1>
<div class="container">
<?php
...
for ($cpt = 0; $cpt < $i; $cpt++)
{
    ...
    {
        echo "<tr><td><hr/>". $rowCommentaire['Commentaire'] ."</td></tr>";
    }
    echo '</table>';
    outilsHTML::optionUtilisateur($resultatToutesMusiques[$cpt]['id_Musique']);
    echo "</div>";
    echo "<br/>";
}
echo "</div>";
